...
export default function Navbar() {
  ...
  return (
    <nav className="bg-black flex flex-col md:flex-row justify-between items-center p-4 font-clash relative">
      ...
      {/* Mobile Menu */}
      <div
        className={`fixed top-0 right-0 bg-black text-white w-full h-full transition-transform duration-300 ease-in-out transform ${isOpen ? "translate-x-0" : "translate-x-full"} z-30`}
          ...
          <li>
            <form onSubmit={handleSearchSubmit} className="flex space-x-2">
              ...
              <button
                ...
                className="bg-white-200 px-1 py-2 rounded-md flex items-center"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="38"
      ...
      {/* Desktop Menu */}
      <ul className="hidden md:flex space-x-12 text-white text-[18px] items-center">
  <li>
  ...
  <li>
    <form onSubmit={handleSearchSubmit} className="flex space-x-4 items-center">
      ...
      {/* Offer and Rent Buttons */}
      <button className="border-2 border-white text-white bg-transparent rounded-full px-9 py-1">
        <a href="/offer">Offer</a>
      </button>
      <button className="border-2 border-black text-black bg-white rounded-full px-9 py-1">
        <a href="/rent">Rent</a>
      </button>
    </form>
  </li>
