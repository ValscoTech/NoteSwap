...
export default function OfferNotesPage() {
  ...
  return (
    <div className={`w-full font-clash min-h-screen flex items-center justify-center p-4 md:p-8 lg:p-12 ${theme === "dark" ? "bg-black text-white" : "bg-white text-black"}`}>
        ...
        <form className="mx-20 space-y-10" onSubmit={handlePostOffer}>
          ...
          <div className="space-y-2">
            ...
            <input
              ...
              autoComplete="off"
              className={`w-full p-2 rounded-md border-b-2 ${theme === "dark" ? "border-white bg-transparent" : "border-black bg-white"} focus:outline-none`}
            />
          </div>
