...
class LoginAuthPage extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<LoginAuthPage> createState() => _LoginAuthPageState();
}

class _LoginAuthPageState extends ConsumerState<LoginAuthPage> {
  var isChecked = false;
                  ...
                  child: Form(
                    ...
                    child: Column(
                      children: [
                        ...
                        SizedBox(height: layout.height * 0.025),
                        Row(
                          children: [
                            Expanded(
                                child: Divider(
